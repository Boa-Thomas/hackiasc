    ...
    <footer className="relative py-16 border-t border-dark-border">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          {/* Links */}
          <div>
            <h4 className="text-sm font-bold text-white mb-4">Evento</h4>
            <ul className="space-y-2">
              {[
                { href: '#sobre', label: 'Sobre' },
                { href: '#cronograma', label: 'Cronograma' },
                { href: '#premios', label: 'Premiacao' },
                { href: '#inscricao', label: 'Inscricao' },
              ].map(({ href, label }) => (
                <li key={href}>
                  <a href={href} className="text-sm text-text-muted hover:text-white transition-colors">{label}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-sm font-bold text-white mb-4">Recursos</h4>
            <ul className="space-y-2">
              <li>
                <a href="#faq" className="text-sm text-text-muted hover:text-white transition-colors">FAQ</a>
              </li>
              <li>
                <a href="/V1. Edital de Participação do Hackathon de IA em Blumenau SC.pdf" target="_blank" className="text-sm text-text-muted hover:text-white transition-colors">
                  Edital Completo (PDF)
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="https://instagram.com/hackia.sc"
                  target="_blank"
              ...
              <li>
                <a
                  href="mailto:vinirosadacosta@gmail.com"
                  className="flex items-center gap-2 text-sm text-text-muted hover:text-white transition-colors"
                >
                  ...
                  vinirosadacosta@gmail.com
                </a>
              </li>
              <li>
                <a
                  href="https://wa.me/5547991708404"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-sm text-text-muted hover:text-white transition-colors"
                >
        ...
        <div className="border-t border-dark-border pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-text-muted font-mono">
            <span className="text-cyan">@</span> Centro de Inovacao de Blumenau
          </p>
        </div>
      </div>
    </footer>
